...
Sie können jetzt die `TridentOrchestrator` erstellen und Trident installieren. Optional können Sie link:../trident-install/kubernetes-customize-deploy.html["Passen Sie Ihre Trident -Installation individuell an."] mit den Attributen in der `TridentOrchestrator`-Spezifikation arbeiten.
