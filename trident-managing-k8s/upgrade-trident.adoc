...
Im Allgemeinen sollten Sie für das Upgrade dieselbe Methode verwenden, die Sie für die Erstinstallation genutzt haben, jedoch können Sie link:../trident-install/kubernetes-deploy.html#moving-between-installation-methods["Wechseln zwischen Installationsmethoden"]. Es gibt zwei Möglichkeiten, Trident zu aktualisieren.
