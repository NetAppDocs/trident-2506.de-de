...
* Wenn Sie von einer Version außerhalb des Vier-Versions-Fensters aktualisieren, führen Sie ein mehrstufiges Upgrade durch.  Befolgen Sie die Upgrade-Anweisungen für dielink:../earlier-versions.html["frühere Version"] Sie führen ein Upgrade von [Version] auf die neueste Version durch, die in den Vier-Versions-Zeitraum passt.  Wenn Sie beispielsweise Version 23.07 verwenden und auf Version 25.06 aktualisieren möchten:
+
