...
summary: Sie können mit der Versionsauswahl zwischen der neuesten Version und den vier vorherigen Versionen navigieren oder die unten stehenden Links verwenden. 
---
...
[role="lead"]
Falls Sie nicht Trident 25.06 verwenden, ist die Dokumentation für frühere Versionen verfügbar.link:get-help.html["Trident Support-Lebenszyklus"] .
