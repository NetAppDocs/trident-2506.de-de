...
* Vor-Ort-Clusterversionen FAS, AFF, Select oder ASA r2 (iSCSI und NVMe/TCP) mit eingeschränktem Support von NetApp. Sehenlink:https://mysupport.netapp.com/site/info/version-support["Softwareversionsunterstützung"] .
